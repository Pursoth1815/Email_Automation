                            ...
                            if (imageFile != null) {
                              ...
                              return CustomPaint(
                                painter: DashedPainter(
                                    color: AppColors.colorPrimarySecondary, strokeWidth: 2, dashPattern: [20, 20], radius: Radius.circular(20)),
                                child: Container(
                                  height: AppConstants.screenHeight * 0.2,
                                  decoration: BoxDecoration(
                        ...
                        child: ElevatedButton(
                          onPressed: () async {
                            if (_titleController.text.isEmpty) {
                              ...
                              showCustomSnackBar(context, "Description Should not be Empty");
                              return;
                            } else if (_locationController.text.isEmpty) {
                              showCustomSnackBar(context, "Location Should not be Empty");
                              return;
                            ...
                            if (await flag) {
                              showCustomSnackBar(context, "Location Should not be Empty", color: AppColors.green);
